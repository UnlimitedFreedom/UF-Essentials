...
public class LocalChatSpyEvent extends Event implements Cancellable {
    ...
    /**
     * Gets the format to use to display this chat message. When this event
     * finishes execution, the first format parameter is the
     * {@link Player#getDisplayName()} and the second parameter is
     * {@link #getMessage()}
     *
    ...
    /**
     * Sets the format to use to display this chat message. When this event
     * finishes execution, the first format parameter is the
     * {@link Player#getDisplayName()} and the second parameter is
     * {@link #getMessage()}
     *
     * @param format {@link String#format(String, Object...)} compatible format
     * string
