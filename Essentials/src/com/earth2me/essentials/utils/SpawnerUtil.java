...
import me.StevenLawson.essentials.EssentialsLogger;
...
public class SpawnerUtil {
    ...
    public SpawnerUtil(IEssentials ess) {
        ...
        if (useMeta) {
            EssentialsLogger.info("Using BlockStateMeta for spawners");
        } else {
            EssentialsLogger.warning("Using legacy item data for spawners");
            EssentialsLogger.warning(ChatColor.RED + "UPGRADE TO SPIGOT 1.8.3 OR HIGHER FOR WORKING SPAWNERS");
        }
    }
