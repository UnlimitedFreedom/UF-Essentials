...
public interface IUser {
    ...
    /**
     * 'Hidden' Represents when a player is hidden from others. This status
     * includes when the player is hidden via other supported plugins. Use
     * isVanished() if you want to check if a user is vanished by Essentials.
     *
     ...
     * Use isHidden() if you want to check if a user is vanished by any
     * supported plugin.
     *
